...
function Blog() {
    return (
        <div className="max-w-screen-2xl container mx-auto pb-8 px-4">
            ...
            <div className="relative text-black">
                <Image
                    src="/images/shop.jpeg" // Replace with the correct image file path
                    alt="Shop Banner"
                    height={400}
                    width={600}
  ...
  <div className="mt-8 w-full lg:w-3/4 gap-6">
    {/* Single Blog Post */}
    {[
      { image: "/images/p4.jpeg", title: "Going all-in with millennial design", category: "Crafts", date: "01 Jan 2023" },
      { image: "/images/p3.jpeg", title: "Exploring new ways of decorating", category: "Design", date: "15 Mar 2023" },
      { image: "/images/p6.jpeg", title: "Handmade pieces that took time to make", category: "Wood", date: "20 Sep 2023" },
    ].map((post, index) => (
