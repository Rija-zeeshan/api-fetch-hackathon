        ...
        <div className="bg-[#fbebb5]  mx-auto  w-full">
            <div className="flex flex-col  md:mx-36 justify-around md:flex-row max-w-screen-2xl  p-20">
                ...
                <div className=" my-auto text-center md:text-left">
                    <h1 className="text-3xl sm:text-4xl md:text-6xl font-semibold my-6 text-black">Rocket single</h1>
                    <span className="text-3xl sm:text-4xl md:text-6xl font-semibold block mb-6 text-black">seater</span>
                    <Link href="/">
                        <p className="text-2xl mt-8 underline underline-offset-8 text-black-600 text-black ">Shop Now</p>
                    </Link>
                </div>
                {/* Image Section */}
            ...
            <div>
                ...
                <div className=" md:flex-row bg-[#FFFFFF] justify-around mx-auto py-10 px-4">
                    ...
                    <div className="flex flex-wrap justify-center md:justify-start  gap-6 ">
                        {/* Product Item */}
                        {[
                            { src: '/images/hero3.jpeg', name: 'Trenton modular sofa_3', price: 'Rs. 25,000.00' },
                            { src: '/images/hero4.jpeg', name: 'Granite dining table with dining chair', price: 'Rs. 25,000.00' },
                            { src: '/images/hero5.jpeg', name: 'Outdoor bar table and stool', price: 'Rs. 25,000.00' },
                            { src: '/images/hero6.jpeg', name: 'Plain console with teak', price: 'Rs. 25,000.00' },
                        ].map((item, index) => (
